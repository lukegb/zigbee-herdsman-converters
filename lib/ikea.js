...
exports.ikeaDirigeraOta = ikeaDirigeraOta;
...
function ikeaDirigeraOta() {
    return (0, modernExtend_1.ota)(ota_1.dirigera);
}
            ...
            await endpoint.configureReporting('manuSpecificIkeaAirPurifier', [
                {
                    ...
                    minimumReportInterval: modernExtend_1.timeLookup['1_MINUTE'],
                    maximumReportInterval: modernExtend_1.timeLookup['1_HOUR'],
                    reportableChange: 1,
                },
            ...
            await endpoint.configureReporting('manuSpecificIkeaAirPurifier', [
                {
                    ...
                    minimumReportInterval: modernExtend_1.timeLookup['1_HOUR'],
                    maximumReportInterval: modernExtend_1.timeLookup['1_HOUR'],
                    reportableChange: 0,
                },
            ], exports.manufacturerOptions);
            await endpoint.configureReporting('manuSpecificIkeaAirPurifier', [{ attribute: 'fanMode', minimumReportInterval: 0, maximumReportInterval: modernExtend_1.timeLookup['1_HOUR'], reportableChange: 1 }], exports.manufacturerOptions);
            await endpoint.configureReporting('manuSpecificIkeaAirPurifier', [{ attribute: 'fanSpeed', minimumReportInterval: 0, maximumReportInterval: modernExtend_1.timeLookup['1_HOUR'], reportableChange: 1 }], exports.manufacturerOptions);
