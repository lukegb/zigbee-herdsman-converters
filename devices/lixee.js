...
const definitions = [
    {
        ...
        options: [
            ...
            e
                ...
                .withValueMin(1)
                .withDescription(`During the poll, request multiple exposes to the Zlinky at once for reducing Zigbee network overload. Too much request at once could exceed device limit. Requires Z2M restart. Default: 1`),
            e
