...
function gledoptoLight(args) {
    ...
    result.toZigbee = utils.replaceInArray(result.toZigbee, [toZigbee_1.default.light_onoff_brightness, toZigbee_1.default.light_colortemp, toZigbee_1.default.light_color, toZigbee_1.default.light_color_colortemp], [
...
function gledoptoOnOff(args) {
    const result = (0, modernExtend_1.onOff)({ powerOnBehavior: false, ...args });
    result.onEvent = async (type, data, device) => {
...
const definitions = [
    ...
    },
    {
        ...
        extend: [(0, modernExtend_1.light)({ colorTemp: { range: [158, 500] } }), (0, modernExtend_1.identify)(), gledoptoConfigureReadModelID()],
    },
    {
    ...
    },
    {
        ...
        extend: [
            (0, modernExtend_1.light)({ colorTemp: { range: [158, 500] }, color: { modes: ['xy', 'hs'], enhancedHue: true } }),
    ...
    },
    {
        ...
        extend: [(0, modernExtend_1.light)(), (0, modernExtend_1.identify)(), gledoptoConfigureReadModelID()],
    },
    {
    ...
    },
    {
        ...
        extend: [(0, modernExtend_1.light)({ colorTemp: { range: [158, 495] }, color: true })],
    },
    {
    ...
    },
    {
        ...
        ota: ota.zigbeeOTA,
        description: 'Zigbee 6W Downlight RGB+CCT (pro)',
        extend: [(0, modernExtend_1.light)({ colorTemp: { range: [158, 500] }, color: { modes: ['xy', 'hs'], enhancedHue: true } }), (0, modernExtend_1.identify)()],
    },
    {
