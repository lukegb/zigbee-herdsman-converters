    ...
    },
    {
        ...
        extend: [
            ...
            (0, modernExtend_1.deviceAddCustomCluster)('3rWateringSpecialCluster', {
                ...
                manufacturerCode: 0x1407,
                attributes: {
                    watering_times: { ID: 0x0000, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                    interval_day: { ID: 0x0001, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                    more_watering_times: { ID: 0x0002, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
                    water_speed_control: { ID: 0x0003, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                },
                commands: {},
                commandsResponse: {},
            }),
