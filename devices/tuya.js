    ...
    scene_recall: {
        ...
        convert: (model, msg, publish, options, meta) => {
            if ((0, utils_1.hasAlreadyProcessedMessage)(msg, model))
                return;
            const payload = { action: (0, utils_1.postfixWithEndpointName)(`scene_${msg.data.sceneid}`, msg, model, meta) };
...
const definitions = [
    ...
    },
    {
        ...
        extend: [(0, modernExtend_1.light)({ colorTemp: { range: [153, 500] }, color: { modes: ['hs'], applyRedFix: true, enhancedHue: false } })],
        configure: async (device, coordinatorEndpoint) => {
            device.getEndpoint(1).saveClusterAttributeKeyValue('lightingColorCtrl', { colorCapabilities: 29 });
        },
    },
    ...
    },
    {
        ...
        extend: [
            tuya.modernExtend.tuyaMagicPacket(),
            (0, modernExtend_1.deviceEndpoints)({ endpoints: { l1: 1, l2: 1 } }),
    ...
    },
    {
        ...
        toZigbee: [
            ...
            toZigbee_1.default.tuya_cover_calibration,
            toZigbee_1.default.tuya_cover_reversal,
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.battery, tuya.fz.on_off_action, fromZigbee_1.default.tuya_operation_mode, fromZigbee_1.default.command_on, fromZigbee_1.default.command_off, fromZigbee_1.default.command_step, fromZigbee_1.default.command_move],
        toZigbee: [toZigbee_1.default.tuya_operation_mode],
        configure: async (device, coordinatorEndpoint) => {
            const endpoint = device.getEndpoint(1);
            await endpoint.read('genBasic', [0x0004, 0x000, 0x0001, 0x0005, 0x0007, 0xfffe]);
    ...
    },
    {
        ...
        vendor: 'Tuya',
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.electrical_measurement, fromZigbee_1.default.metering, fromZigbee_1.default.ignore_basic_report, tuya.fz.power_outage_memory, tuya.fz.switch_type],
    ...
    },
    {
        ...
        description: 'Switch with power monitoring',
        vendor: 'Tuya',
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.electrical_measurement, fromZigbee_1.default.metering, fromZigbee_1.default.ignore_basic_report, tuya.fz.power_on_behavior_1, tuya.fz.switch_type],
        toZigbee: [toZigbee_1.default.on_off, tuya.tz.power_on_behavior_1, tuya.tz.switch_type],
        configure: async (device, coordinatorEndpoint) => {
            const endpoint = device.getEndpoint(1);
            await tuya.configureMagicPacket(device, coordinatorEndpoint);
    ...
    },
    {
        ...
        extend: [
            ...
            (0, modernExtend_1.onOff)({ endpointNames: ['left', 'center', 'right'], powerOnBehavior: false }),
        ],
        whiteLabel: [
    ...
    },
    {
        ...
        vendor: 'Tuya',
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.electrical_measurement, fromZigbee_1.default.metering, fromZigbee_1.default.ignore_basic_report, tuya.fz.power_outage_memory, tuya.fz.indicator_mode],
    ...
    },
    {
        ...
        vendor: 'Tuya',
        description: 'Wall-mount thermostat',
        fromZigbee: [fromZigbee_1.default.ignore_basic_report, fromZigbee_1.default.ignore_tuya_set_time, legacy.fromZigbee.x5h_thermostat],
    ...
    },
    {
        ...
        fromZigbee: [
            ...
            fromZigbee_1.default.command_step_color_temperature,
            fromZigbee_1.default.command_stop_move_raw,
            fromZigbee_1.default.tuya_multi_action,
            fromZigbee_1.default.tuya_operation_mode,
            fromZigbee_1.default.battery,
        ],
        toZigbee: [toZigbee_1.default.tuya_operation_mode],
    ...
    },
    {
        ...
        extend: [(0, modernExtend_1.light)({ powerOnBehavior: false, configureReporting: true })],
    ...
    },
    {
        ...
        ota: ota.zigbeeOTA,
        fromZigbee: [fromZigbee_1.default.TS110E, fromZigbee_1.default.TS110E_light_type, tuya.fz.power_on_behavior_1, fromZigbee_1.default.on_off],
        toZigbee: [toZigbee_1.default.TS110E_onoff_brightness, toZigbee_1.default.TS110E_options, tuya.tz.power_on_behavior_1, toZigbee_1.default.light_brightness_move],
        exposes: [
    ...
    },
    {
        ...
        vendor: 'Ekaza',
        description: '1 channel dimmer',
        fromZigbee: [fromZigbee_1.default.TS110E, tuya.fz.power_on_behavior_1, fromZigbee_1.default.on_off],
        toZigbee: [toZigbee_1.default.TS110E_onoff_brightness, toZigbee_1.default.TS110E_options, tuya.tz.power_on_behavior_1, toZigbee_1.default.light_brightness_move],
    ...
    },
    {
        ...
        extend: [
            (0, modernExtend_1.deviceEndpoints)({ endpoints: { l1: 1, l2: 2 } }),
            (0, modernExtend_1.light)({ powerOnBehavior: false, endpointNames: ['l1', 'l2'], configureReporting: true }),
        ],
        fromZigbee: [tuya.fz.power_on_behavior_1, fromZigbee_1.default.TS110E_switch_type, fromZigbee_1.default.TS110E],
        toZigbee: [toZigbee_1.default.TS110E_light_onoff_brightness, tuya.tz.power_on_behavior_1, toZigbee_1.default.TS110E_options],
        configure: tuya.configureMagicPacket,
        exposes: [
        ...
        meta: {
            tuyaDatapoints: [
                ...
                [
                    3,
                    'fan_speed',
                    tuya.valueConverterBasic.lookup({ '1': tuya.enum(0), '2': tuya.enum(1), '3': tuya.enum(2), '4': tuya.enum(3), '5': tuya.enum(4) }, '5'),
                ],
                [11, 'power_on_behavior', tuya.valueConverterBasic.lookup({ OFF: tuya.enum(0), ON: tuya.enum(1) })],
                [5, 'status_indication', tuya.valueConverter.onOff],
            ],
    ...
    },
    {
        ...
        extend: [
            ...
            (0, modernExtend_1.iasZoneAlarm)({ zoneType: 'generic', zoneAttributes: ['battery_low'] }),
        ],
    },
    {
    ...
    },
    {
        ...
        extend: [(0, modernExtend_1.temperature)(), (0, modernExtend_1.humidity)(), (0, modernExtend_1.identify)({ isSleepy: true }), (0, modernExtend_1.battery)({ voltage: true })],
    },
    {
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.TS110E, fromZigbee_1.default.on_off],
        toZigbee: [toZigbee_1.default.TS110E_onoff_brightness, toZigbee_1.default.TS110E_options, toZigbee_1.default.light_brightness_move],
