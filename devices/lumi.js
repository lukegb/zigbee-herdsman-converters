...
const definitions = [
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.temperature, fromZigbee_1.default.humidity, lumi.fromZigbee.lumi_pm25, lumi.fromZigbee.lumi_co2],
        toZigbee: [],
    ...
    },
    {
        ...
        fromZigbee: [lumi.fromZigbee.lumi_power, lumi.fromZigbee.lumi_specific, ...(0, modernExtend_1.light)({ colorTemp: { range: undefined }, color: true }).fromZigbee],
        toZigbee: [
            lumi.toZigbee.lumi_dimmer_mode,
            lumi.toZigbee.lumi_switch_power_outage_memory,
            ...(0, modernExtend_1.light)({ colorTemp: { range: undefined }, color: true }).toZigbee,
        ],
        exposes: [
            e.power(),
            e.energy(),
        ...
        extend: [(0, modernExtend_1.deviceEndpoints)({ endpoints: { l1: 1, l2: 2 } }), lumiZigbeeOTA()],
    },
    {
    ...
    },
    {
        ...
        extend: [
            ...
            (0, modernExtend_1.forceDeviceType)({ type: 'Router' }),
    ...
    },
    {
        ...
        extend: [
            (0, modernExtend_1.light)({ effect: false, powerOnBehavior: false, colorTemp: { startup: false, range: [153, 370] }, color: true }),
            lumiPowerOnBehavior(),
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, lumi.fromZigbee.lumi_power, lumi.fromZigbee.lumi_specific, lumi.fromZigbee.lumi_action_multistate],
        toZigbee: [
            toZigbee_1.default.on_off,
            lumi.toZigbee.lumi_switch_operation_mode_opple,
            lumi.toZigbee.lumi_switch_power_outage_memory,
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.electrical_measurement, lumi.fromZigbee.lumi_action_multistate, lumi.fromZigbee.lumi_specific],
        toZigbee: [
            toZigbee_1.default.on_off,
    ...
    },
    {
        ...
        toZigbee: [toZigbee_1.default.on_off, { ...lumi.toZigbee.lumi_switch_operation_mode_basic, convertGet: null }],
        endpoint: (device) => {
    ...
    },
    {
        ...
        fromZigbee: [
            ...
            lumi.fromZigbee.lumi_basic,
            lumi.fromZigbee.lumi_operation_mode_basic,
            fromZigbee_1.default.ignore_multistate_report,
        ...
        toZigbee: [toZigbee_1.default.on_off, lumi.toZigbee.lumi_switch_operation_mode_basic, lumi.toZigbee.lumi_power],
        endpoint: (device) => {
            return { system: 1 };
        },
        extend: [lumiZigbeeOTA(), lumiPreventReset()],
    ...
    },
    {
        ...
        toZigbee: [toZigbee_1.default.on_off, { ...lumi.toZigbee.lumi_switch_operation_mode_basic, convertGet: null }, lumi.toZigbee.lumi_power],
        meta: { multiEndpoint: true },
        endpoint: (device) => {
    ...
    },
    {
        ...
        toZigbee: [toZigbee_1.default.on_off, lumi.toZigbee.lumi_switch_operation_mode_basic],
        endpoint: (device) => {
            return { system: 1, default: 2 };
        },
        extend: [lumiPreventReset()],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, lumi.fromZigbee.lumi_power, lumi.fromZigbee.lumi_basic, lumi.fromZigbee.lumi_action_multistate],
    ...
    },
    {
        ...
        extend: [
            lumiZigbeeOTA(),
            (0, modernExtend_1.deviceEndpoints)({ endpoints: { left: 1, right: 2 } }),
    ...
    },
    {
        ...
        fromZigbee: [lumi.fromZigbee.lumi_occupancy_illuminance, lumi.fromZigbee.lumi_specific, fromZigbee_1.default.battery],
    ...
    },
    {
        ...
        fromZigbee: [lumi.fromZigbee.lumi_occupancy, lumi.fromZigbee.lumi_specific, fromZigbee_1.default.battery],
    ...
    },
    {
        ...
        vendor: 'Xiaomi',
        fromZigbee: [fromZigbee_1.default.on_off, lumi.fromZigbee.lumi_power, lumi.fromZigbee.lumi_basic, fromZigbee_1.default.ignore_occupancy_report, fromZigbee_1.default.ignore_illuminance_report],
        toZigbee: [toZigbee_1.default.on_off, lumi.toZigbee.lumi_switch_power_outage_memory, lumi.toZigbee.lumi_power],
    ...
    },
    {
        ...
        vendor: 'Xiaomi',
        fromZigbee: [fromZigbee_1.default.on_off, lumi.fromZigbee.lumi_power, lumi.fromZigbee.lumi_basic, fromZigbee_1.default.ignore_occupancy_report, fromZigbee_1.default.ignore_illuminance_report],
        toZigbee: [toZigbee_1.default.on_off, lumi.toZigbee.lumi_power],
    ...
    },
    {
        ...
        fromZigbee: [
            ...
            lumi.fromZigbee.lumi_power,
            lumi.fromZigbee.lumi_specific,
            fromZigbee_1.default.ignore_occupancy_report,
            fromZigbee_1.default.ignore_illuminance_report,
    ...
    },
    {
        ...
        vendor: 'Aqara',
        extend: [(0, modernExtend_1.forceDeviceType)({ type: 'Router' }), lumiZigbeeOTA()],
        fromZigbee: [
            fromZigbee_1.default.on_off,
            lumi.fromZigbee.lumi_basic,
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, lumi.fromZigbee.lumi_power, fromZigbee_1.default.ignore_occupancy_report, lumi.fromZigbee.lumi_basic],
        toZigbee: [
            toZigbee_1.default.on_off,
            lumi.toZigbee.lumi_power,
            lumi.toZigbee.lumi_led_disabled_night,
        ...
        extend: [(0, modernExtend_1.customTimeResponse)('2000_LOCAL')],
    },
    {
        ...
        vendor: 'Aqara',
        fromZigbee: [fromZigbee_1.default.on_off, lumi.fromZigbee.lumi_power, lumi.fromZigbee.lumi_basic],
        toZigbee: [toZigbee_1.default.on_off, lumi.toZigbee.lumi_switch_power_outage_memory, lumi.toZigbee.lumi_power],
        exposes: [
            e.switch(),
            e.power().withAccess(ea.STATE_GET),
    ...
    },
    {
        ...
        fromZigbee: [lumi.fromZigbee.lumi_specific, fromZigbee_1.default.battery],
        toZigbee: [
            lumi.toZigbee.lumi_alarm,
            lumi.toZigbee.lumi_density,
            lumi.toZigbee.lumi_selftest,
    ...
    },
    {
        ...
        extend: [
            (0, modernExtend_1.windowCovering)({ controls: ['lift'], coverInverted: true, configureReporting: true }),
            lumiCurtainSpeed(),
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.battery, lumi.fromZigbee.lumi_curtain_position_tilt, lumi.fromZigbee.lumi_specific, fromZigbee_1.default.power_source],
        toZigbee: [
            lumi.toZigbee.lumi_curtain_position_state,
    ...
    },
    {
        ...
        fromZigbee: [lumi.fromZigbee.lumi_basic, lumi.fromZigbee.lumi_power, fromZigbee_1.default.ignore_multistate_report, fromZigbee_1.default.on_off, lumi.fromZigbee.lumi_basic_raw],
        meta: { multiEndpoint: true },
        toZigbee: [toZigbee_1.default.on_off, lumi.toZigbee.lumi_interlock, lumi.toZigbee.lumi_power, lumi.toZigbee.lumi_switch_power_outage_memory],
        endpoint: (device) => {
            return { l1: 1, l2: 2 };
        },
        exposes: [
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, lumi.fromZigbee.lumi_specific, lumi.fromZigbee.lumi_power],
    ...
    },
    {
        ...
        vendor: 'Aqara',
        fromZigbee: [lumi.fromZigbee.lumi_door_lock_report, fromZigbee_1.default.ignore_basic_report],
        toZigbee: [],
        exposes: [
            e.binary('state', ea.STATE, 'UNLOCK', 'LOCK'),
            e.binary('reverse', ea.STATE, 'UNLOCK', 'LOCK'),
    ...
    },
    {
        ...
        extend: [(0, modernExtend_1.light)({ colorTemp: { range: undefined }, color: { modes: ['xy', 'hs'] } }), lumiZigbeeOTA()],
    },
    {
        ...
        extend: [(0, modernExtend_1.light)(), lumiZigbeeOTA()],
    },
    {
    ...
    },
    {
        ...
        fromZigbee: [
            ...
            fromZigbee_1.default.device_temperature,
            lumi.fromZigbee.lumi_specific,
            fromZigbee_1.default.ignore_metering,
            fromZigbee_1.default.ignore_electrical_measurement,
            lumi.fromZigbee.lumi_power,
        ],
        exposes: [
            e.switch(),
        ...
        toZigbee: [lumi.toZigbee.lumi_switch_type, toZigbee_1.default.on_off, lumi.toZigbee.lumi_switch_power_outage_memory, lumi.toZigbee.lumi_led_disabled_night],
        configure: async (device, coordinatorEndpoint) => {
            const endpoint = device.getEndpoint(1);
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, lumi.fromZigbee.lumi_power, lumi.fromZigbee.lumi_specific],
        toZigbee: [
            toZigbee_1.default.on_off,
            lumi.toZigbee.lumi_power,
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, lumi.fromZigbee.lumi_specific],
        exposes: [e.switch(), e.power_outage_memory(), e.switch_type(), e.power_outage_count(), e.device_temperature()],
        toZigbee: [lumi.toZigbee.lumi_switch_type, toZigbee_1.default.on_off, lumi.toZigbee.lumi_switch_power_outage_memory],
        configure: async (device, coordinatorEndpoint) => {
            const endpoint = device.getEndpoint(1);
            await reporting.bind(endpoint, coordinatorEndpoint, ['genOnOff']);
            await reporting.onOff(endpoint);
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, lumi.fromZigbee.lumi_smart_panel_ZNCJMB14LM],
        toZigbee: [toZigbee_1.default.on_off, lumi.toZigbee.lumi_smart_panel_ZNCJMB14LM],
        meta: { multiEndpoint: true },
        endpoint: (device) => {
            return { left: 1, center: 2, right: 3 };
        },
    ...
    },
    {
        ...
        fromZigbee: [lumi.fromZigbee.lumi_action_multistate, lumi.fromZigbee.lumi_specific, fromZigbee_1.default.command_toggle],
        toZigbee: [lumi.toZigbee.lumi_switch_click_mode, lumi.toZigbee.lumi_operation_mode_opple],
        exposes: [
            e.battery(),
            e.battery_voltage(),
    ...
    },
    {
        ...
        fromZigbee: [lumi.fromZigbee.lumi_trv, fromZigbee_1.default.thermostat, fromZigbee_1.default.battery],
        toZigbee: [lumi.toZigbee.lumi_trv, toZigbee_1.default.thermostat_occupied_heating_setpoint],
        exposes: [
    ...
    },
    {
        ...
        extend: [
            lumiZigbeeOTA(),
            lumiPreventReset(),
            (0, modernExtend_1.deviceEndpoints)({ endpoints: { top: 1, center: 2, bottom: 3, wireless: 4 } }),
            lumiOnOff({
                operationMode: true,
                powerOutageMemory: 'enum',
                lockRelay: true,
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, lumi.fromZigbee.lumi_action_multistate, lumi.fromZigbee.lumi_specific, lumi.fromZigbee.lumi_power],
        toZigbee: [
            toZigbee_1.default.on_off,
            lumi.toZigbee.lumi_switch_operation_mode_opple,
            lumi.toZigbee.lumi_switch_power_outage_memory,
