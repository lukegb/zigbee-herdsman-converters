...
const definitions = [
    ...
    },
    {
        ...
        extend: [(0, philips_1.philipsLight)({ colorTemp: { range: [222, 454] } })],
    },
    {
        zigbeeModel: ['SOC001'],
        model: '9290035639',
        ...
        fromZigbee: [fromZigbee_1.default.battery, philips_1.philipsFz.philips_contact],
        toZigbee: [],
    ...
    },
    {
        ...
        extend: [(0, philips_1.philipsLight)({ colorTemp: { range: [154, 455] }, color: true })],
    },
    {
        zigbeeModel: ['LWA023'],
        model: '9290030516',
    ...
    },
    {
        ...
        extend: [(0, philips_1.philipsLight)({ hueEffect: true })],
    },
    {
        zigbeeModel: ['LWO005'],
        model: '9290030519',
    ...
    },
    {
        ...
        extend: [(0, philips_1.philipsLight)({ colorTemp: { range: [153, 500] }, color: true, gradient: true })],
    },
    {
    ...
    },
    {
        ...
        extend: [(0, philips_1.philipsLight)({ colorTemp: { range: [153, 500] } })],
    },
    {
    ...
    },
    {
        ...
        extend: [(0, philips_1.philipsLight)({ colorTemp: { range: undefined } })],
    },
    {
    ...
    },
    {
        ...
        extend: [(0, philips_1.philipsLight)({ color: true })],
    },
    {
    ...
    },
    {
        ...
        vendor: 'Philips',
        description: 'Hue white ambiance E27 with Bluetooth',
        extend: [(0, philips_1.philipsLight)({ colorTemp: { range: [153, 434] } })],
    },
    {
        zigbeeModel: ['LCP003'],
        model: '4090631P7',
    ...
    },
    {
        ...
        extend: [
            (0, modernExtend_1.deviceEndpoints)({ endpoints: { top: 11, bottom: 12 } }),
            (0, philips_1.philipsLight)({ colorTemp: { range: [153, 500] }, color: true, endpointNames: ['top', 'bottom'] }),
        ],
    },
    {
    ...
    },
    {
        ...
        extend: [(0, philips_1.philipsLight)({ colorTemp: { range: undefined }, hueEffect: false })],
    },
    {
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.battery, fromZigbee_1.default.hue_wall_switch_device_mode, fromZigbee_1.default.hue_wall_switch, fromZigbee_1.default.command_toggle, fromZigbee_1.default.command_move, fromZigbee_1.default.command_stop],
        exposes: [
            e.battery(),
            e.action([
                'left_press',
    ...
    },
    {
        ...
        fromZigbee: [
            ...
            fromZigbee_1.default.hue_motion_sensitivity,
            fromZigbee_1.default.hue_motion_led_indication,
        ],
        exposes: [
            e.temperature(),
            e.occupancy(),
        ...
        toZigbee: [toZigbee_1.default.occupancy_timeout, philips_1.philipsTz.hue_motion_sensitivity, philips_1.philipsTz.hue_motion_led_indication],
        endpoint: (device) => {
    ...
    },
    {
        ...
        extend: [(0, philips_1.philipsOnOff)()],
    },
    {
    ...
    },
    {
        ...
        vendor: 'Philips',
        description: 'Hue white ambiance Aurelle round panel light',
        extend: [(0, modernExtend_1.identify)(), (0, philips_1.philipsLight)({ colorTemp: { range: [153, 454] } })],
    },
    {
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.ignore_command_step, philips_1.philipsFz.hue_tap_dial, fromZigbee_1.default.battery, fromZigbee_1.default.command_step],
        toZigbee: [],
        exposes: [
            e.battery(),
            e.action([
    ...
    },
    {
        ...
        extend: [(0, philips_1.philipsLight)({ colorTemp: { range: [153, 500] }, color: true, gradient: { extraEffects: ['sparkle', 'opal', 'glisten'] } })],
    },
    {
        zigbeeModel: ['LCX015'],
        model: '9290036744',
    ...
    },
    {
        ...
        extend: [(0, philips_1.philipsLight)({ colorTemp: { range: [153, 500] }, color: true, turnsOffAtBrightness1: true })],
    },
    {
    ...
    },
    {
        ...
        extend: [(0, philips_1.philipsLight)({ colorTemp: { range: [153, 438] } })],
    },
    {
